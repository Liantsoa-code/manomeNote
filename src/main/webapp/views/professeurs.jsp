        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="form-add">
                    ...
                    <form action="professeurs?action=add" method="post">
                    ...
                    <tbody>
                        <c:forEach var="p" items="${professeurs}">
                            <tr>
                                <td>${p.id}</td>
                                <td>
                                    <form action="professeurs?action=update&id=${p.id}" method="post"
                                        style="display:inline;">
                                        <input type="text" name="nom" value="${p.nom}" style="width: auto;">
                                        <button type="submit" class="btn btn-edit">Modifier</button>
                                    </form>
                                </td>
                                <td>
                                    <a href="professeurs?action=delete&id=${p.id}" class="btn btn-delete"
