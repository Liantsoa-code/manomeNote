        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="form-add">
                    ...
                    <form action="matieres?action=add" method="post">
                    ...
                    <tbody>
                        <c:forEach var="m" items="${matieres}">
                            <tr>
                                <td>${m.id}</td>
                                <td>
                                    <form action="matieres?action=update&id=${m.id}" method="post"
                                        style="display:inline;">
                                        <input type="text" name="nom" value="${m.nom}" style="width: auto;">
                                        <button type="submit" class="btn btn-edit">Modifier</button>
                                    </form>
                                </td>
                                <td>
                                    <a href="matieres?action=delete&id=${m.id}" class="btn btn-delete"
